...
PLAYER_STATS_ID VARCHAR(255) NOT NULL DEFAULT '',
BATTING_STATS_ID VARCHAR(255) NOT NULL,
BOWLING_STATS_ID VARCHAR(255) NOT NULL,
PRIMARY KEY(PLAYER_STATS_ID),
FOREIGN KEY (BATTING_STATS_ID) REFERENCES BATTING_STATS(BATTING_STATS_ID), 
FOREIGN KEY (BOWLING_STATS_ID) REFERENCES BOWLING_STATS(BOWLING_STATS_ID));
...
FOREIGN KEY (HOME_TEAM_ID, AWAY_TEAM_ID) REFERENCES TEAM(TEAM_ID));